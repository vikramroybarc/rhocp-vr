...
registerMooseObject("RhocpApp", DDCPStressUpdate3);

InputParameters
DDCPStressUpdate3::validParams()
{
...
DDCPStressUpdate3::DDCPStressUpdate3(const InputParameters & parameters) :
...
DDCPStressUpdate3::~DDCPStressUpdate3()
{
}

void DDCPStressUpdate3::initQpStatefulProperties()
{
...
void DDCPStressUpdate3::computeQpStress()
{
...
// NR_residual()
void DDCPStressUpdate3::NR_residual (
...
void DDCPStressUpdate3::readPropsFile() {
...
void DDCPStressUpdate3::assignProperties(){
...
void DDCPStressUpdate3::normalize_vector(Real *x, Real *y, Real *z) {
...
void DDCPStressUpdate3::rotate_4th(Real a[3][3], Real b[3][3][3][3], Real (&c)[3][3][3][3]) {
  Real d[3][3][3][3];
...
void DDCPStressUpdate3::forth_to_Voigt(Real a[3][3][3][3], Real (&b)[6][6]) {
...
void DDCPStressUpdate3::Voigt_to_forth(Real b[6][6], Real (&a)[3][3][3][3]) {
  for(unsigned int i = 1; i <= 3; i++) {
...
void DDCPStressUpdate3::aaaa_dot_dot_bbbb(Real a[3][3][3][3], Real b[3][3][3][3], Real (&product)[3][3][3][3]) {
...
void DDCPStressUpdate3::aaaa_dot_dot_bb(Real a[3][3][3][3], Real b[3][3], Real (&product)[3][3]) {
...
void DDCPStressUpdate3::aa_dot_bb(Real a[3][3], Real b[3][3], Real (&product)[3][3]) {
...
Real DDCPStressUpdate3::aa_dot_dot_bb(Real a[3][3], Real b[3][3]) {
...
void DDCPStressUpdate3::bunge_angles(Real (&array1)[3][3], Real (&psi0)[3]) {
...
Real DDCPStressUpdate3::power(Real x, Real y) {
...
Real DDCPStressUpdate3::sgn(Real x) {
...
Real DDCPStressUpdate3::max_val(Real a, Real b)
{
  if (a>b)
  {
    return a;
...
int DDCPStressUpdate3::numrows(std::string filename){
    int numlines{0};
...
int DDCPStressUpdate3::numcols(std::string filename){
    int columncount{0};
    std::ifstream file(filename);
    if (!file.is_open()){
...
void DDCPStressUpdate3::readfile(std::string filename){
...
void DDCPStressUpdate3::calc_crss(
      ...
      void DDCPStressUpdate3::calc_sliprate(
        unsigned int num_slip_sys,
      ...
      void DDCPStressUpdate3::calc_climbrate(
        unsigned int num_slip_sys,
        Real Di,
        Real Dv,
        Real vacdensity_th,
     ...
     void DDCPStressUpdate3::calc_mfp(
      unsigned int num_slip_sys,
      std::vector<Real> &rho_m,
      std::vector<Real> &rho_i,
      std::vector<Real> &Nloop,
