...
registerMooseObject("RhocpApp", DDJ2StressUpdate2);

InputParameters
DDJ2StressUpdate2::validParams()
{
...
void DDJ2StressUpdate2::initQpStatefulProperties()
{
...
void DDJ2StressUpdate2::computeQpStress()
{
...
void DDJ2StressUpdate2::readPropsFile() {
...
void DDJ2StressUpdate2::assignProperties(){
...
void DDJ2StressUpdate2::normalize_vector(Real *x, Real *y, Real *z) {
...
void DDJ2StressUpdate2::rotate_4th(Real a[3][3], Real b[3][3][3][3], Real (&c)[3][3][3][3]) {
  Real d[3][3][3][3];
...
void DDJ2StressUpdate2::forth_to_Voigt(Real a[3][3][3][3], Real (&b)[6][6]) {
...
void DDJ2StressUpdate2::Voigt_to_forth(Real b[6][6], Real (&a)[3][3][3][3]) {
  for(unsigned int i = 1; i <= 3; i++) {
...
void DDJ2StressUpdate2::aaaa_dot_dot_bbbb(Real a[3][3][3][3], Real b[3][3][3][3], Real (&product)[3][3][3][3]) {
...
void DDJ2StressUpdate2::aaaa_dot_dot_bb(Real a[3][3][3][3], Real b[3][3], Real (&product)[3][3]) {
...
void DDJ2StressUpdate2::aa_dot_dot_bbbb(Real a[3][3], Real b[3][3][3][3], Real (&product)[3][3]) {
...
void DDJ2StressUpdate2::aa_dot_bb(Real a[3][3], Real b[3][3], Real (&product)[3][3]) {
...
Real DDJ2StressUpdate2::aa_dot_dot_bb(Real a[3][3], Real b[3][3]) {
...
Real DDJ2StressUpdate2::power(Real x, Real y) {
...
Real DDJ2StressUpdate2::sgn(Real x) {
...
Real DDJ2StressUpdate2::max_val(Real a, Real b)
{
  if (a>b)
  {
    return a;
