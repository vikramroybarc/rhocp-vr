...
class DDCPStressUpdate3P1 : public ComputeStressBase
{
public:
  static InputParameters validParams();

  DDCPStressUpdate3P1(const InputParameters & parameters);
  virtual ~DDCPStressUpdate3P1();
