...
class DDCPStressUpdate2 : public ComputeStressBase
{
public:
  static InputParameters validParams();

  DDCPStressUpdate2(const InputParameters & parameters);
  virtual ~DDCPStressUpdate2();
...
void calc_dsadgb(
  ...
  k_D_0,                //35 Immobile Dislocation Evolution Dynamic Recovery Constant
  n0,                   //36 Dynamic Recovery strain rate exponent
  edot0;                //37 Reference Strain Rate for Dynamic Recovery
